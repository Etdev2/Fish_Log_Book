...
export const SPECIES: readonly Species[] = [
  ...
  // ——— Wave 4 (AK + HI, 2026-09-02): ADF&G Southeast booklet + DLNR DAR table vocabulary.
  { id: "pink_salmon", commonName: "Pink salmon (humpy)", scientificName: "Oncorhynchus gorbuscha", isGroup: false, rollsUpTo: null, waterClass: "salt", takeStatus: "regulated", sortOrder: 471 },
  { id: "chum_salmon", commonName: "Chum salmon", scientificName: "Oncorhynchus keta", isGroup: false, rollsUpTo: null, waterClass: "salt", takeStatus: "regulated", sortOrder: 472 },
  { id: "sockeye_salmon", commonName: "Sockeye salmon", scientificName: "Oncorhynchus nerka", isGroup: false, rollsUpTo: null, waterClass: "salt", takeStatus: "regulated", sortOrder: 473 },
  { id: "dolly_varden", commonName: "Dolly Varden", scientificName: "Salvelinus malma", isGroup: false, rollsUpTo: null, waterClass: "salt", takeStatus: "open", sortOrder: 474 },
  { id: "moi", commonName: "Moi (Pacific threadfin)", scientificName: "Polydactylus sexfilis", isGroup: false, rollsUpTo: null, waterClass: "salt", takeStatus: "regulated", sortOrder: 475 },
  { id: "oio_bonefish", commonName: "'O'io (Hawaiian bonefish)", scientificName: "Albula virgata", isGroup: false, rollsUpTo: null, waterClass: "salt", takeStatus: "regulated", sortOrder: 476 },
  { id: "awa", commonName: "Awa (milkfish)", scientificName: "Chanos chanos", isGroup: false, rollsUpTo: null, waterClass: "salt", takeStatus: "regulated", sortOrder: 477 },
  { id: "aholehole", commonName: "Aholehole (Hawaiian flagtail)", scientificName: "Kuhlia sandvicensis", isGroup: false, rollsUpTo: null, waterClass: "salt", takeStatus: "regulated", sortOrder: 478 },
  { id: "uhu", commonName: "Uhu (parrotfish)", scientificName: "Scaridae", isGroup: true, rollsUpTo: null, waterClass: "salt", takeStatus: "regulated", sortOrder: 479 },
  { id: "weke", commonName: "Weke (yellowstripe goatfish)", scientificName: "Mulloidichthys flavolineatus", isGroup: false, rollsUpTo: null, waterClass: "salt", takeStatus: "regulated", sortOrder: 480 },
  { id: "kole", commonName: "Kole (goldring surgeonfish)", scientificName: "Ctenochaetus strigosus", isGroup: false, rollsUpTo: null, waterClass: "salt", takeStatus: "regulated", sortOrder: 481 },
  { id: "manini", commonName: "Manini (convict tang)", scientificName: "Acanthurus triostegus", isGroup: false, rollsUpTo: null, waterClass: "salt", takeStatus: "regulated", sortOrder: 482 },
  { id: "kala", commonName: "Kala (bluespine unicornfish)", scientificName: "Naso unicornis", isGroup: false, rollsUpTo: null, waterClass: "salt", takeStatus: "regulated", sortOrder: 483 },
  { id: "onaga", commonName: "Onaga ('ula'ula koa'e)", scientificName: "Etelis coruscans", isGroup: false, rollsUpTo: null, waterClass: "salt", takeStatus: "regulated", sortOrder: 484 },
  { id: "opakapaka", commonName: "'Opakapaka", scientificName: "Etelis carbunculus", isGroup: false, rollsUpTo: null, waterClass: "salt", takeStatus: "regulated", sortOrder: 485 },
  { id: "ehu", commonName: "Ehu ('ula'ula)", scientificName: "Etelis marshalli", isGroup: false, rollsUpTo: null, waterClass: "salt", takeStatus: "regulated", sortOrder: 486 },
  { id: "hapuu", commonName: "Hapu'u (Hawaiian grouper)", scientificName: "Epinephelus quernus", isGroup: false, rollsUpTo: null, waterClass: "salt", takeStatus: "regulated", sortOrder: 487 },
