  ...
  questions: [
    {
      ...
      options: [
        { id: "blow-tall", label: "Tall narrow column, very high" },
        { id: "blow-bushy", label: "Bushy, cloud-shaped" },
        { id: "blow-v", label: "V-shaped, two spouts" },
        { id: "blow-low", label: "Low, wide or heart-shaped" },
        { id: "blow-none", label: "No blow seen" },
      ],
    },
    {
      id: "dorsal",
      ...
      options: [
        { id: "dorsal-none", label: "No fin at all" },
        { id: "dorsal-hump", label: "A hump or row of knuckles, not a fin" },
        { id: "dorsal-small-back", label: "Small fin, set well back" },
        { id: "dorsal-tall-hooked", label: "Tall and hooked" },
        { id: "dorsal-tall-straight", label: "Very tall and straight" },
        { id: "dorsal-curved", label: "Curved, mid-back, dolphin-like" },
        { id: "dorsal-triangle", label: "Small dark triangle" },
      ],
    },
    {
      id: "size",
